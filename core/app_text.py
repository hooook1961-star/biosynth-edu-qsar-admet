...
APP_TEXT: dict[str, dict[str, str]] = {
    ...
    "kk": {
        ...
        "metric.bbb_rf": "RF-модель бойынша BBB арқылы өту ықтималдығы",
        "help.bbb_rf": "BBB үшін қосымша ML-сигнал. Негізгі оқу талдауы дескрипторлар мен Gupta формуласына сүйенеді.",
