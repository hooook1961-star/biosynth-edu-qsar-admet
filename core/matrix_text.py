...
MATRIX_TEXT: dict[str, dict[str, Any]] = {
    ...
    "kk": {
        "title": "BBB × P-gp матрицасы",
        "intro": "Матрица екі сұрақты біріктіреді: молекула BBB арқылы пассивті өте ала ма және P-gp арқылы белсенді шығарылу қаупі бар ма.",
        "current": "Ағымдағы сценарий",
        "columns": {"bbb": "BBB арқылы өту", "pgp": "P-gp", "scenario": "Оқу сценарийі", "interpretation": "Түсіндірме", "current": "Ағымдағы"},
        "current_labels": {
        ...
        "cells": {
            "bbb_high_pgp_low": {"bbb_label": "BBB: жоғары баға", "pgp_label": "P-gp: субстратқа ұқсамайды", "label": "Профиль ОЖЖ қолжетімділігін қолдайды", "interpretation": "Молекула BBB арқылы өтуге қолайлы көрінеді және P-gp арқылы белсенді шығарылу қаупі жоғары емес."},
            "bbb_high_pgp_high": {"bbb_label": "BBB: жоғары баға", "pgp_label": "P-gp: ықтимал субстрат", "label": "Қайшылық: BBB арқылы өтеді, бірақ P-gp шығаруы мүмкін", "interpretation": "BBB арқылы пассивті өту қолайлы, бірақ P-gp ОЖЖ қолжетімділігін төмендетуі мүмкін."},
            "bbb_low_pgp_low": {"bbb_label": "BBB: төмен баға", "pgp_label": "P-gp: субстратқа ұқсамайды", "label": "Негізгі шектеу - BBB арқылы өту қасиеттері", "interpretation": "P-gp басты шектеу емес; негізгі мәселе молекуланың физика-химиялық профилімен байланысты."},
            "bbb_low_pgp_high": {"bbb_label": "BBB: төмен баға", "pgp_label": "P-gp: ықтимал субстрат", "label": "ОЖЖ үшін қос шектеу", "interpretation": "Молекулаға BBB арқылы пассивті өту қасиеттері де, P-gp арқылы белсенді шығарылу да кедергі болуы мүмкін."},
            ...
            "insufficient_data": {"bbb_label": "BBB: баға жоқ", "pgp_label": "P-gp: баға жоқ", "label": "Дерек жеткіліксіз", "interpretation": "Матрицалық түсіндіру үшін BBB немесе P-gp бағасы жеткіліксіз."},
        },
        "expander": "P-gp BBB түсіндірмесін қалай өзгертеді?",
        "expander_text": "BBB арқылы өту бағасы жоғары болса да, P-gp молекуланы қанға қайта шығарып, ОЖЖ қолжетімділігін төмендетуі мүмкін.",
    },
    "en": {
