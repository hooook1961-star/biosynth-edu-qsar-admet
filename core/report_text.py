...
REPORT_TEXT: dict[str, dict[str, Any]] = {
    ...
    "kk": {
        "title": "BioSynth-EDU: ADMET, қан-ми тосқауылы және ОЖЖ бойынша оқу есебі",
        ...
        "positive": "Қан-ми тосқауылынан өту мен ОЖЖ қолжетімділігін қолдайды",
        "negative": "Қан-ми тосқауылынан өтуге немесе ОЖЖ қолжетімділігіне кедергі жасайды",
        ...
        "scores_table": [
            ...
            ("Қан-ми тосқауылы үшін Gupta формуласы бойынша көрсеткіш", "gupta_bbb_score"),
        ...
        "student_questions_list": [
            "Қан-ми тосқауылынан өтуді ең көп қолдайтын дескрипторлар қайсы?",
            "ОЖЖ қолжетімділігін ең көп шектейтін фактор қандай?",
            "Қан-ми тосқауылынан пассивті өту мен P-gp арқылы белсенді шығарылу арасында қайшылық бар ма?",
