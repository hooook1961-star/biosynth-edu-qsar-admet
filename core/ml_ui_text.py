...
ML_UI_TEXT = {
    "ru": {
        ...
        "bbb_use": (
            "Это дополнительная статистическая модель для гематоэнцефалического барьера (ГЭБ, BBB). "
            "Основной учебный разбор лучше читать через дескрипторы: размер, липофильность, полярность, "
            "водородные связи и заряд. По ним легче увидеть химическую причину вывода."
        ),
    ...
    "kk": {
        ...
        "bbb_use": (
            "Бұл гематоэнцефалдық бөгетке (BBB) арналған қосымша статистикалық модель. Негізгі оқу "
            "талдауын дескрипторлар арқылы оқыған дұрыс: өлшем, липофильділік, полярлық, сутектік "
            "байланыстар және заряд. Олар қорытындының химиялық себебін жақсырақ көрсетеді."
        ),
