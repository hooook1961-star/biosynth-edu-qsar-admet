...
ML_UI_TEXT = {
    ...
    "kk": {
        ...
        "pgp_use": (
            ...
            "BBB арқылы пассивті өту қолайлы көрінсе де, ОЖЖ үшін қолжетімділік төмендеуі мүмкін."
        ),
        "bbb_use": (
        ...
        "class_bbb_1": "профиль BBB арқылы өтетін қосылыстарға ұқсайды",
        "class_bbb_0": "профиль BBB арқылы нашар өтетін қосылыстарға ұқсайды",
        "note_fallback": (
