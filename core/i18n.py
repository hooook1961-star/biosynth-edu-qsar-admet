...
UI = {'ru': {'language.select': 'Тіл / Язык / Language',
        ...
        'batch.review_needed': 'Требуют проверки',
        'batch.borderline': 'Пограничный ГЭБ-профиль',
        'batch.low_bbb': 'Слабый ГЭБ-профиль',
        ...
        'sidebar.subtitle': '**ADMET: ГЭБ + P-gp**',
        'sidebar.info': 'pKa + P-gp + формула Gupta + Clint',
        ...
        'help.bbb_gupta': 'Расчётный показатель по модифицированной формуле Gupta для оценки прохождения через гематоэнцефалический барьер: вместо фиксированного pKa 8.81 используется предсказанное pKa, если оно доступно. Источник: Gupta, Lee, Barden & Weaver, Journal of Medicinal Chemistry, 2019.',
        ...
        'help.pka': 'Динамический pKa используется как часть гибридного индекса ГЭБ.',
        ...
        'batch.page_title': '📂 Массовый скрининг ADMET / ГЭБ / P-gp',
        'batch.intro_stage5': 'Массовая таблица дополняется кратким учебным объяснением для каждой молекулы: итоговый класс для ЦНС, сценарий '
                              'ГЭБ × P-gp, факторы за/против, предупреждения и уровень неопределённости.',
        ...
        'batch.run_button': '🚀 Запустить массовый расчёт ADMET / ГЭБ',
        'batch.progress': 'Расчёт: {progress}',
        'batch.done': 'Массовый расчёт ADMET / ГЭБ завершён.',
        'batch.invalid_smiles_error': 'Некорректная структура SMILES',
        'batch.calculation_error': 'Ошибка расчёта: {error_type}: {error}',
        'batch.tab_summary': '📊 Учебная сводка',
        'batch.tab_full_table': '🧪 Полная таблица ADMET',
        'batch.tab_export': '📥 Экспорт',
        'batch.show_all_columns': 'Показать все batch-колонки',
        'batch.download_excel': '📥 Скачать Excel: screening_results',
        'batch.download_csv': '📥 Скачать CSV: screening_results',
        'batch.download_interpretation': '📥 Скачать интерпретацию Markdown',
        'batch.interpretation_title': 'Как читать групповой отчёт',
 ...
 'kk': {'language.select': 'Тіл / Язык / Language',
        ...
        'batch.review_needed': 'Тексеру қажет',
        'batch.borderline': 'Қан-ми тосқауылы профилі шекаралық',
        'batch.low_bbb': 'Қан-ми тосқауылы профилі әлсіз',
        'batch.summary': '#### Батчтың қысқа түйіні',
        'batch.table': 'Оқу басымдығы бойынша сұрыпталған батч кестесі',
        'sidebar.language': 'Тіл / Язык / Language',
        'sidebar.subtitle': '**ADMET: қан-ми тосқауылы + P-gp**',
        'sidebar.info': 'pKa + P-gp + Gupta формуласы + Clint',
        ...
        'help.caco2': 'LogPapp өткізгіштік коэффициентінің логарифмін болжау. LogPapp > -5.0: асқазан-ішек жолында жақсы сіңу. LogPapp < '
                      '-6.0: нашар сіңу.',
        'help.bbb_gupta': 'Қан-ми тосқауылынан өтуді бағалауға арналған модификацияланған Gupta формуласы бойынша есептік көрсеткіш: тұрақты pKa 8.81 орнына, қолжетімді болса, болжанған pKa қолданылады. Дереккөз: Gupta, Lee, Barden және Weaver, Journal of Medicinal Chemistry, 2019.',
        ...
        'help.pka': 'Динамикалық pKa қан-ми тосқауылының гибридті индексінің бір бөлігі ретінде қолданылады.',
        ...
        'batch.page_title': '📂 Жаппай ADMET / қан-ми тосқауылы / P-gp скринингі',
        ...
        'batch.run_button': '🚀 Жаппай ADMET / қан-ми тосқауылы есебін іске қосу',
        'batch.progress': 'Есептеу: {progress}',
        'batch.done': 'Жаппай ADMET / қан-ми тосқауылы есебі аяқталды.',
        'batch.invalid_smiles_error': 'SMILES құрылымы дұрыс емес',
        'batch.calculation_error': 'Есептеу қатесі: {error_type}: {error}',
        'batch.tab_summary': '📊 Оқу қорытындысы',
        'batch.tab_full_table': '🧪 Толық ADMET кестесі',
        'batch.tab_export': '📥 Экспорт',
        'batch.show_all_columns': 'Барлық batch-бағандарды көрсету',
        'batch.download_excel': '📥 Excel жүктеу: screening_results',
        'batch.download_csv': '📥 CSV жүктеу: screening_results',
        'batch.download_interpretation': '📥 Markdown түсіндірмесін жүктеу',
        'batch.interpretation_title': 'Топтық есепті қалай оқу керек',
 ...
 'en': {'language.select': 'Language',
        ...
        'batch.review_needed': 'Need review',
        'batch.borderline': 'Borderline BBB profile',
        'batch.low_bbb': 'Low BBB profile',
        'batch.summary': '#### Batch summary',
        'batch.table': 'Batch table sorted by educational priority',
        'sidebar.language': 'Language',
        'sidebar.subtitle': '**ADMET: BBB + P-gp**',
        ...
        'help.caco2': 'Predicted log permeability coefficient LogPapp. LogPapp > -5.0: good intestinal absorption. LogPapp < -6.0: poor '
                      'absorption.',
        'help.bbb_gupta': 'Computational indicator based on a modified Gupta formula for estimating blood-brain barrier passage: predicted pKa is used when available instead of the fixed pKa value 8.81. Source: Gupta, Lee, Barden & Weaver, Journal of Medicinal Chemistry, 2019.',
        ...
        'batch.download_excel': '📥 Download Excel: screening_results',
        'batch.download_csv': '📥 Download CSV: screening_results',
        'batch.download_interpretation': '📥 Download Markdown interpretation',
        'batch.interpretation_title': 'How to read the batch report',
