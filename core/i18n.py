...
UI = {
    "ru": {
        ...
        "metric.bbb": "BBB normalized score",
...
METHODOLOGY = {
    "ru": [
        ...
        {"title": "5. Rule-based explainability", "text": "Учебное объяснение строится по понятным правилам и диапазонам дескрипторов."},
    ],
    "kk": [
        ...
        {"title": "5. Rule-based explainability", "text": "Оқу түсіндірмесі түсінікті ережелер мен дескриптор диапазондарына сүйенеді."},
    ],
    "en": [
        ...
        {"title": "5. Rule-based explainability", "text": "The educational explanation uses interpretable descriptor rules and ranges."},
    ],
}
...
UI.setdefault("ru", {}).update({
    ...
    "report.descriptors": "Дескрипторы и объяснения",
    "report.factors": "Факторы за и против",
    "report.generated_at": "Дата генерации UTC",
    "report.molecule": "Молекула",
    "report.questions": "Вопросы для студента",
    "report.scores": "Основные score",
    "report.steps": "Пошаговое решение модели",
    "report.summary": "Итоговый учебный вывод",
    "report.title": "BioSynth-EDU: учебный отчёт Explainable ADMET/BBB",
...
UI.setdefault("kk", {}).update({
    ...
    "report.descriptors": "Дескрипторлар және түсіндірмелер",
    "report.factors": "Оң және теріс факторлар",
    "report.generated_at": "UTC генерация уақыты",
    "report.molecule": "Молекула",
    "report.questions": "Студентке сұрақтар",
    "report.scores": "Негізгі score",
    "report.steps": "Модель шешімінің қадамдары",
    "report.summary": "Қорытынды оқу тұжырымы",
    "report.title": "BioSynth-EDU: Explainable ADMET/BBB оқу есебі",
...
UI.setdefault("en", {}).update({
    ...
    "report.descriptors": "Descriptors and explanations",
    "report.factors": "Factors for and against",
    "report.generated_at": "Generated at UTC",
    "report.molecule": "Molecule",
    "report.questions": "Questions for students",
    "report.scores": "Main scores",
    "report.steps": "Stepwise model trace",
    "report.summary": "Final educational conclusion",
    "report.title": "BioSynth-EDU: Explainable ADMET/BBB student report",
